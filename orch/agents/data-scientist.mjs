/**
 * DataScientistAgent - FULLY FUNCTIONAL agent generated from data-scientist.md
 * Use this agent for data analysis, statistical modeling, and experimentation.
 * 
...
export class DataScientistAgent extends Agent {
  constructor() {
    super({
      name: 'data-scientist',
      role: 'data-scientist',
      ...
      allowedTools: ["*"],
      metadata: {
        source: 'data-scientist.md',
        kpis: "Uplift accuracy, experiment turnaround, decision adoption.",
        collaborators: ["ai-pm"]
      }
    });
  ...
  async analyzeTask(task) {
    ...
    if (desc.includes('collaborate') || desc.includes('coordinate')) {
      ...
      analysis.collaborators = ["ai-pm"];
    }
    
    // Determine approach
    analysis.approach = 'Apply data-scientist expertise to solve the task';
  ...
  async performWork(task, analysis) {
    ...
    // Default work implementation for data-scientist
  ...
  canHandleTask(task) {
    ...
    if (task.requirements?.role === 'data-scientist') return true;
    ...
    const desc = task.description?.toLowerCase() || '';
    desc.includes('analytics') || desc.includes('modeling') || desc.includes('experiment') || desc.includes('clear') ? true : false;
...
export const data_scientistAgent = new DataScientistAgent();
